...
const NFL_STATIC_FALLBACK: NFBCPlayer[] = [
  ...
  // ── Round 2 (13–24) ─────────────────────────────────────────────────────────
  { rank: 13,  playerName: 'Cooks, Brandin',          displayName: 'Brandin Cooks',          adp: 15.2,  positions: 'WR',  team: 'DAL',  valueDelta: 2.2,  isValuePick: false },
  ...
  { rank: 51,  playerName: 'Gibbs, Jahmyr',           displayName: 'Jahmyr Gibbs',           adp: 55.5,  positions: 'RB',  team: 'DET',  valueDelta: 4.5,  isValuePick: false },
  { rank: 52,  playerName: 'Watson, Christian',       displayName: 'Christian Watson',       adp: 57.0,  positions: 'WR',  team: 'GB',   valueDelta: 5.0,  isValuePick: false },
  { rank: 53,  playerName: 'Lazard, Allen',           displayName: 'Allen Lazard',           adp: 60.0,  positions: 'WR',  team: 'NYJ',  valueDelta: 7.0,  isValuePick: false },
  { rank: 54,  playerName: 'Tonyan, Robert',          displayName: 'Robert Tonyan',          adp: 62.0,  positions: 'TE',  team: 'CHI',  valueDelta: 8.0,  isValuePick: false },
  { rank: 55,  playerName: 'Harris, Damien',          displayName: 'Damien Harris',          adp: 65.0,  positions: 'RB',  team: 'BUF',  valueDelta: 10.0, isValuePick: false },
  ...
  { rank: 66,  playerName: 'Lawrence, Trevor',        displayName: 'Trevor Lawrence',        adp: 74.5,  positions: 'QB',  team: 'JAC',  valueDelta: 8.5,  isValuePick: false },
  { rank: 67,  playerName: 'Williams, Jaylen',        displayName: 'Jaylen Williams',        adp: 77.0,  positions: 'RB',  team: 'LV',   valueDelta: 10.0, isValuePick: false },
  { rank: 68,  playerName: 'Godwin, Chris',           displayName: 'Chris Godwin',           adp: 79.0,  positions: 'WR',  team: 'TB',   valueDelta: 11.0, isValuePick: false },
  ...
  { rank: 75,  playerName: 'Walker, Kenneth III',     displayName: 'Kenneth Walker III',     adp: 80.0,  positions: 'RB',  team: 'SEA',  valueDelta: 5.0,  isValuePick: false },
  { rank: 76,  playerName: 'Wilson, Zach',            displayName: 'Zach Wilson',            adp: 83.0,  positions: 'QB',  team: 'NYJ',  valueDelta: 7.0,  isValuePick: false },
  { rank: 77,  playerName: 'London, Drake',           displayName: 'Drake London',           adp: 86.0,  positions: 'WR',  team: 'ATL',  valueDelta: 9.0,  isValuePick: false },
  { rank: 78,  playerName: 'Jones, Aaron',            displayName: 'Aaron Jones',            adp: 88.5,  positions: 'RB',  team: 'GB',   valueDelta: 10.5, isValuePick: false },
  { rank: 79,  playerName: 'Williams, Rachaad',       displayName: 'Rachaad Williams',       adp: 90.5,  positions: 'RB',  team: 'TB',   valueDelta: 11.5, isValuePick: false },
  { rank: 80,  playerName: 'Jefferson, Van',          displayName: 'Van Jefferson',          adp: 93.0,  positions: 'WR',  team: 'LAR',  valueDelta: 13.0, isValuePick: false },
  { rank: 81,  playerName: 'Cooper, Amari',           displayName: 'Amari Cooper',           adp: 91.5,  positions: 'WR',  team: 'CLE',  valueDelta: 10.5, isValuePick: false },
  { rank: 82,  playerName: 'Kelley, Joshua',          displayName: 'Joshua Kelley',          adp: 94.0,  positions: 'RB',  team: 'LAC',  valueDelta: 12.0, isValuePick: false },
  ...
  { rank: 86,  playerName: 'Fields, Justin',          displayName: 'Justin Fields',          adp: 92.0,  positions: 'QB',  team: 'CHI',  valueDelta: 6.0,  isValuePick: false },
  ...
  { rank: 91,  playerName: 'Gainwell, Kenneth',       displayName: 'Kenneth Gainwell',       adp: 98.0,  positions: 'RB',  team: 'PHI',  valueDelta: 7.0,  isValuePick: false },
  ...
  // ── Round 9 (97–108) ────────────────────────────────────────────────────────
  { rank: 97,  playerName: 'Hurts, Jalen',            displayName: 'Jalen Hurts',            adp: 103.0, positions: 'QB',  team: 'PHI',  valueDelta: 6.0,  isValuePick: false },
  ...
  { rank: 103, playerName: 'Sanders, Miles',          displayName: 'Miles Sanders',          adp: 109.0, positions: 'RB',  team: 'CAR',  valueDelta: 6.0,  isValuePick: false },
  ...
  { rank: 105, playerName: 'Gus, Okonkwo',            displayName: 'Chig Okonkwo',           adp: 113.0, positions: 'TE',  team: 'TEN',  valueDelta: 8.0,  isValuePick: false },
  { rank: 106, playerName: 'Flowers, Kadarius',       displayName: 'Kadarius Toney',         adp: 116.0, positions: 'WR',  team: 'KC',   valueDelta: 10.0, isValuePick: false },
  ...
  { rank: 108, playerName: 'Tucker, Evan',            displayName: 'Evan McPherson',         adp: 118.0, positions: 'K',   team: 'CIN',  valueDelta: 10.0, isValuePick: false },
  // ── Round 10 (109–120) ──────────────────────────────────────────────────────
  { rank: 109, playerName: 'Watson, Deshaun',         displayName: 'Deshaun Watson',         adp: 117.0, positions: 'QB',  team: 'CLE',  valueDelta: 8.0,  isValuePick: false },
  ...
  { rank: 114, playerName: 'Peoples-Jones, Donovan',  displayName: 'Donovan Peoples-Jones',  adp: 120.0, positions: 'WR',  team: 'CLE',  valueDelta: 6.0,  isValuePick: false },
  ...
  { rank: 119, playerName: 'Amendola, Danny',         displayName: 'Brandin Cooks',          adp: 126.5, positions: 'WR',  team: 'HOU',  valueDelta: 7.5,  isValuePick: false },
