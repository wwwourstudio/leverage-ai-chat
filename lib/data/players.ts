...
export function getPlayerHeadshotUrl(playerName: string): string | null {
  ...
  if (entry.sport === 'mlb') {
    return `https://img.mlbstatic.com/mlb-photos/image/upload/d_people:generic:headshot:silo:current.png,w_213,q_auto:best/v1/people/${entry.id}/headshot/silo/current`;
  }
  return null;
}
