  ...
  return (
    <div className="px-4 pb-4 pt-3 space-y-3">
      ...
      <div className="grid grid-cols-3 gap-1.5">
        {[0, 1, 2].map(i => (
          <div key={i} className="flex flex-col items-center gap-1.5 rounded-xl bg-[var(--bg-overlay)] border border-[var(--border-subtle)] px-2 py-2.5">
...
function MinimalSkeletonBody() {
  return (
    <div className="px-4 pb-4 pt-2 space-y-3">
      <div className="h-3 w-full bg-[var(--bg-elevated)] rounded animate-pulse" />
      <div className="h-3 w-4/5 bg-[var(--bg-elevated)] rounded animate-pulse" style={{ animationDelay: '60ms' }} />
      <div className="h-3 w-2/3 bg-[var(--bg-surface)] rounded animate-pulse" style={{ animationDelay: '120ms' }} />
      <div className="h-8 w-full rounded-xl bg-[var(--bg-overlay)] border border-[var(--border-subtle)] animate-pulse mt-1" />
    </div>
  );
}
  ...
  return (
    <div className="px-4 pb-4 pt-3 space-y-3">
      <div className="grid grid-cols-2 gap-2">
        {[0, 1, 2, 3].map(i => (
          <div key={i} className="rounded-xl bg-[var(--bg-overlay)] border border-[var(--border-subtle)] p-3 space-y-2" style={{ animationDelay: `${i * 50}ms` }}>
            <div className="h-2 w-3/4 bg-[var(--bg-surface)] rounded animate-pulse" />
            <div className="h-5 w-1/2 bg-[var(--bg-elevated)] rounded animate-pulse" />
          </div>
        ))}
      </div>
      <div className="h-8 w-full rounded-xl bg-[var(--bg-overlay)] border border-[var(--border-subtle)] animate-pulse" />
...
export function CardGrid({ count = 3, variant, className = '' }: { count?: number; variant?: SkeletonVariant; className?: string }) {
  return (
  ...
  return (
    <div className="p-4 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="text-[length:var(--text-label)] text-[var(--text-muted)] ml-1">
